...
class DQNSolver:
    def __init__(self, observation_space, action_space):
        ...
        if not os.listdir('Reinforcement Learning/gym/models/models/') and MODE == 'Train':
            # creating the model
        ...
        elif not os.listdir('Reinforcement Learning/gym/models/models/') and MODE == 'Test':
            print('Error: No Model available')
            sys.exit()
        else:
            # use an existing model
            self.model = load_model('Reinforcement Learning/gym/models/models/CartPole-v1.h5')

        # tensorboard for analytics
        self.tensorboard = ModifiedTensorBoard(log_dir="Reinforcement Learning/gym/logs/")
        # model checkpoints
        self.checkpoint = ModelCheckpoint(f'Reinforcement Learning/gym/models/checkpoints/CartPole-v1_checkpoint.h5', monitor=str(np.mean(self.all_steps)), verbose=1, mode='auto')
    ...
    def save_model(self, run, step):
        ...
        self.model.save(f'Reinforcement Learning/gym/models/models/CartPole-v1.h5')
