...
class DQNSolver:
    def __init__(self, observation_space, action_space):
        ...
        self.model.add(Conv2D(124, kernel_size=(3, 3), input_shape=(210, 160, 3), activation='elu'))
        self.model.add(Conv2D(124, kernel_size=(3, 3), activation='elu'))
        ...
        self.target_model.add(Dense(64, input_shape=(observation_space,), activation="elu"))
        self.target_model.add(Dense(64, activation="elu"))
        self.target_model.add(Dropout(0.2))

        self.target_model.add(Dense(24, activation="elu"))
        self.target_model.add(Dense(24, activation="elu"))
        self.target_model.add(Dropout(0.2))

        self.target_model.add(Dense(self.action_space, activation="linear"))
        self.target_model.compile(loss="mse", optimizer=Adam(lr=LEARNING_RATE, amsgrad=True))
        ...
        self.tensorboard = ModifiedTensorBoard(log_dir="Reinforcement Learning/MsPacman/logs/")
    ...
    def save_model(self):
        self.model.save_weights('Reinforcement Learning/MsPacman/models/CartPole-v1.h5')
        self.model.save_weights('Reinforcement Learning/MsPacman/models/CartPole_target-v1.h5')
